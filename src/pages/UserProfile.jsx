    ...
    <div className='container profile__container'>
       ...
       <div className='profile__details'>
             ...
             {error &&  <p className='form__error-message'>
              ...
              <input type='password' name='password' placeholder='Password' value={currentPassword} onChange={e=>setCurrentPassword(e.target.value)}/>
              <input type='password' name='newPassword' placeholder='New Password' value={newPassword} onChange={e=>setNewPassword(e.target.value)}/>
              <input type='password' name='confirmNewPassword' placeholder='Confirm New Password' value={confirmNewPassword} onChange={e=>setConfirmNewPassword(e.target.value)}/>  
